...
<div
	transition:fly={{ y: 50 }}
	class="fixed z-50 max-w-md p-2 text-white shadow-lg {typeClasses[
		type
...
>
	<div class="flex items-center justify-between">
		<p>{message}</p>
		<button onclick={closeToast} class="ml-4 text-white hover:text-gray-200 focus:outline-none" aria-label="Close toast">
