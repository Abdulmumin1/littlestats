...
<button
	...
	onclick={sendFilter}
	class="flex w-full justify-between group rounded-md text-left bg-stone-50 dark:border-x-[13px] border-{$color}-700 px-[9px] py-[3px] dark:bg-stone-800/50 dark:text-gray-100"
>
