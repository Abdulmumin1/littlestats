	  ...
	  <div class="flex flex-col md:flex-row items-center justify-between">
		...
		<DarkMode/>
		  ...
		  <div 
			...
			class="relative items-center gap-1 rounded-full dark:border border-stone-800 py-2 bg-{$color}-100 text-black  dark:bg-stone-800/50 p-1 backdrop-blur-sm "
		  >
		  ...
		  <a
			href="/signup"
			class="group relative  inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-{$color}-500 to-purple-500 px-4 py-2 text-sm font-semibold text-black dark:text-white transition-all hover:-translate-y-0.5 "
		  >
			Start free
